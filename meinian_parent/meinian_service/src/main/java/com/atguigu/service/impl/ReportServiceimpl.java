...
public class ReportServiceimpl implements ReportService {
    ...
    public Map<String, Object> getBusinessReportData() {
        ...
        try {
            ...
            //7.本周预约数
            HashMap<String, Object> paramWeek = new HashMap<>();
            ...
            //8.本周出游数
            HashMap<String,Object> paramWeekVisit = new HashMap<>();
            ...
            //9.本月预约数
            HashMap<String, Object> paramMonth = new HashMap<>();
            ...
            //10.本月出游数
            HashMap<String, Object> paramMonthVisit = new HashMap<>();
